...
/// Maps a z-score in [-clamp, +clamp] to red→yellow→green.
fn z_color(z: f64, clamp: f64) -> String {
...
pub fn write_tournament_svg(
    ...
    z_matrix: &[Vec<f64>],
    rankings: &[(usize, f64, f64)], // (team_idx, total_diff, total_z)
    ...
    // z-clamp: use 95th-percentile of off-diagonal z values
